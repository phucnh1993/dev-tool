...
@Table(name = "DatabaseInfos", indexes = {
		@Index(name = "ix_database_search", columnList = "Activated, Name", unique = false)		
})
...
public class Database {
	...
	@JoinColumn(name = "BasicTypeId"
			, foreignKey=@ForeignKey(name = "fk_database_infos_basic_type")
	...
	@Column(name = "IpAddressV4", nullable = true, length = 15
			, columnDefinition = "varchar(15) COLLATE ascii_bin")
    private String ipAddressV4;
	
	@Column(name = "IpAddressV6", nullable = true, length = 45
			, columnDefinition = "varchar(45) COLLATE ascii_bin")
	...
	@Column(name = "Username", nullable = true, length = 128
			, columnDefinition = "varchar(128) COLLATE ascii_bin")
